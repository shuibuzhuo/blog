...
默认属性和方法是 public 的，但是这样外界可以随意访问和修改这些属性和方法，非常危险
...
- 设置成 private，属性和方法就只能在该类里面使用了
- 但是改成 private 后，类实现接口就会有问题，所以要去掉 private 属性在接口里的定义
...
既然不能随意在外部访问属性和方法了，就需要提供 setter 和 getter 来提供对应的操作
